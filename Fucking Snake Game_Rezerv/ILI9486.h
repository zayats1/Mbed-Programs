...
class ILI9486 : public TFT
{
 ...
 public:
    ...
    */ 
    ...
    ILI9486(proto_t displayproto, PinName* buspins, PinName CS, PinName reset, PinName DC, PinName WR, PinName RD, const char* name, unsigned int LCDSIZE_X = 320, unsigned  int LCDSIZE_Y = 480);
